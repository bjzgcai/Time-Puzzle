...
export type RouteViewMode = "two-stage" | "single-map";
...
export const CHINA_CENTER: LonLat = { lon: 104.5, lat: 35.2 };
export const BEIJING_COORD: LonLat = { lon: 116.4074, lat: 39.9042 };
export const HAIDIAN_PARK_COORD: LonLat = { lon: 116.225723, lat: 40.087606 };
export const DESTINATION_NAME = "北京市 海淀区 海淀大悦信息科技园";

export const ROUTE_VIEW_MODE: RouteViewMode = "two-stage";

export const PHOTO_SET: PhotoItem[] = [
  {
    date: "2026-03-26",
    name: "吴衍标",
    src: "./data/吴衍标.jpg",
